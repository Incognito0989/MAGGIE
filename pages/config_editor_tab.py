...
from components.service_selector import ServiceConfigSelector
...
def create_config_editor_tab(notebook, services_dir):
    ...
    selector = ServiceConfigSelector(config_editor_tab)
    selector.pack(fill="both", expand=True, padx=10, pady=10)  # Make sure to pack it
